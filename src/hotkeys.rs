...
pub fn iced_key_to_livesplit_hotkey(
    ...
    use livesplit_core::hotkey::KeyCode::{
        Again, AltLeft, AltRight, ArrowDown, ArrowLeft, ArrowRight, ArrowUp, AudioVolumeDown,
        ...
        BrowserStop, CapsLock, Comma, ContextMenu, ControlLeft, ControlRight, Convert, Copy, Cut,
        Delete, Digit0, Digit1, Digit2, Digit3, Digit4, Digit5, Digit6, Digit7, Digit8, Digit9,
        Eject, End, Enter, Equal, Escape, F1, F2, F3, F4, F5, F6, F7, F8, F9, F10, F11, F12, F13,
        F14, F15, F16, F17, F18, F19, F20, F21, F22, F23, F24, Find, Fn, FnLock, Help, Home,
        Insert, IntlBackslash, IntlRo, IntlYen, KanaMode, KeyA, KeyB, KeyC, KeyD, KeyE, KeyF, KeyG,
        KeyH, KeyI, KeyJ, KeyK, KeyL, KeyM, KeyN, KeyO, KeyP, KeyQ, KeyR, KeyS, KeyT, KeyU, KeyV,
        KeyW, KeyX, KeyY, KeyZ, Lang1, Lang2, Lang3, Lang4, Lang5, LaunchApp1, LaunchApp2,
        LaunchMail, MediaPlayPause, MediaSelect, MediaStop, MediaTrackNext, MediaTrackPrevious,
        MetaLeft, MetaRight, Minus, NonConvert, NumLock, Numpad0, Numpad1, Numpad2, Numpad3,
        ...
        NumpadStar, NumpadSubtract, Open, PageDown, PageUp, Paste, Pause, Period, Power,
        PrintScreen, Props, Quote, ScrollLock, Select, Semicolon, ShiftLeft, ShiftRight, Slash,
        Sleep, Space, Tab, Undo, WakeUp,
    };
    let key = match key {
